   ...
   , mSkyShader()
{
   ...
   std::vector<std::string> faces { "resources/models/sky/px.png",
                                    "resources/models/sky/nx.png",
                                    "resources/models/sky/py.png",
                                    "resources/models/sky/ny.png",
                                    "resources/models/sky/pz.png",
                                    "resources/models/sky/nz.png" };
